...
SEXP testall ( SEXP aSEXP , SEXP type_testSEXP ) {
 ...
 sexp size;sexp temp;sexp ret;sexp m1;sexp m2;sexp b;sexp c;sexp d;sexp e;sexp f;sexp v;sexp m;sexp rs;sexp cs;sexp x; 
BorrowSEXP a ;a=aSEXP; 
BorrowSEXP type_test ;type_test=type_testSEXP; 
