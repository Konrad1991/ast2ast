...
template <typename T, typename L, typename R> class VVPLUS {
...
template <typename T, typename L, typename R> class VSPLUS {
...
template <typename T, typename L, typename R> class SVPLUS {
