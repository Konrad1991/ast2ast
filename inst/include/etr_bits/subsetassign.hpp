...
inline VEC<double> &
subassign(VEC<double> &inp,
          long *p) { // gets nullptr long* does not work why? // done
  inp.rsi(inp.size());
  for (int i = 0; i < inp.size(); i++) {
    inp.indices[i] = i;
  }
...
inline VEC<double> &subassign(VEC<double> &inp, int row,
                              VEC<double> &pos) { // done
...
inline VEC<double> &subassign(VEC<double> &inp, VEC<double> &pos,
                              int col) { // done
...
inline VEC<double> &subassign(VEC<double> &inp, double row_,
                              long *nptr) { // done
  int row = d2i(row_);
...
inline VEC<double> &subassign(VEC<double> &inp, long *ptr,
                              double col_) { // done
  int col = d2i(col_);
...
inline VEC<double> &subassign(VEC<double> &inp, bool r,
                              VEC<double> &pos) { // done
...
inline VEC<double> &subassign(VEC<double> &inp, long *r,
                              VEC<double> &pos) { // done
...
inline VEC<double> &subassign(VEC<double> &inp, VEC<double> &rpos,
...
inline VEC<double> &subassign(VEC<double> &inp,
                              const VEC<T2, R2> &pos) { // done // VEC<double>&&
  inp.rsi(pos.size());
  inp.subsetted = true;
...
template <typename T2, typename R2>
inline VEC<double> &subassign(VEC<double> &inp, const VEC<T2, R2> &pos,
                              int col) { // done
...
inline VEC<double> &subassign(VEC<double> &inp, VEC<bool> pos,
                              int col) { // done
...
inline VEC<double> &subassign(VEC<double> &inp, const VEC<T2, R2> &rpos,
...
template <typename T2, typename R2>
inline VEC<double> &subassign(VEC<double> &inp, const VEC<T2, R2> &rows,
                              VEC<bool> pos) { // done
...
inline VEC<double> &subassign(VEC<double> &inp, VEC<double> &rows,
                              VEC<bool> pos) { // done
...
inline VEC<double> &subassign(VEC<double> &inp, VEC<bool> rows,
                              VEC<bool> cols) { // done
