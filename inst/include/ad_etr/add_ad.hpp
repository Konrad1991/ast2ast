  ...
  */
  ...
  template <typename T, typename L, typename R, typename Trait = VVPlusTrait> class VVPLUS {
  ...
  template <typename T, typename L, typename R, typename Trait = VSPlusTrait> class VSPLUS {
