...
auto sinus(const T& obj) -> BaseType{ return Sinus(obj); }
...
template<typename T>
requires std::is_same_v<T, BaseType>
auto sinush(const T& obj) -> BaseType{ return SinusH(obj); }
...
template<typename T>
requires std::is_same_v<T, BaseType>
auto asinus(const T& obj) -> BaseType{ return ASinus(obj); }
...
template<typename T>
requires std::is_same_v<T, BaseType>
auto cosinus(const T& obj) -> BaseType{ return Cosinus(obj); }
...
template<typename T>
requires std::is_same_v<T, BaseType>
auto cosinush(const T& obj) -> BaseType{ return CosinusH(obj); }
...
template<typename T>
requires std::is_same_v<T, BaseType>
auto acosinus(const T& obj) -> BaseType{ return ACosinus(obj); }
...
template<typename T>
requires std::is_same_v<T, BaseType>
auto tangens(const T& obj) -> BaseType{ return Tangens(obj); }
...
template<typename T>
requires std::is_same_v<T, BaseType>
auto tangensh(const T& obj) -> BaseType{ return TangensH(obj); }
...
template<typename T>
requires std::is_same_v<T, BaseType>
auto atangens(const T& obj) -> BaseType{ return ATangens(obj); }
...
template<typename T>
requires std::is_same_v<T, BaseType>
auto ln(const T& obj) -> BaseType{ return Log(obj); }
...
template<typename T>
requires std::is_same_v<T, BaseType>
auto sqroot(const T& obj) -> BaseType{ return SquareRoot(obj); }
...
template<typename T>
requires std::is_same_v<T, BaseType>
auto exp(const T& obj) -> BaseType{ return Exp(obj); }
