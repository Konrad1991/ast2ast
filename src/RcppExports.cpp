...
RcppExport SEXP _ast2ast_test_colon_AllVars() {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
    test_colon_AllVars();
    return R_NilValue;
...
// test_derivs
void test_derivs();
RcppExport SEXP _ast2ast_test_derivs() {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
    test_derivs();
    return R_NilValue;
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_ast2ast_test_colon_AllVars", (DL_FUNC) &_ast2ast_test_colon_AllVars, 0},
    {"_ast2ast_test_concepts", (DL_FUNC) &_ast2ast_test_concepts, 0},
    {"_ast2ast_test_derivs", (DL_FUNC) &_ast2ast_test_derivs, 0},
