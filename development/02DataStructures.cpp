...
int main() {
  {
    Vec<double> v1 = c(1.1, 2.2, 3.3);
    double* address1 = v1.d.p;
    Vec<double> v2(v1);
    double* address2 = v2.d.p;
    ass<"Vector/Buffer content is copied">(address1 != address2);
  }
  {
    Vec<double> v(sinus(c(1.1, 2.2, 3.3)));
  }
