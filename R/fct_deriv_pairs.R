...
init_fct_list <- function() {
  ...
  f <- add_fct(f, "etr::vector_logical", vector_deriv, TRUE)
  f <- add_fct(f, "etr::vector_integer", vector_deriv, TRUE)
  f <- add_fct(f, "etr::vector_numeric", vector_deriv, TRUE)
  f <- add_fct(f, "etr::rep", rep_deriv, TRUE)
  f <- add_fct(f, "etr::matrix", matrix_deriv, TRUE)
  f <- add_fct(f, "etr::coca", matrix_deriv, TRUE)
  f <- add_fct(f, "etr::cmr", matrix_deriv, TRUE)
  return(f)
}
