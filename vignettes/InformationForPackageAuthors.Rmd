...
**The variables are not changed or stored as sexp variable. Thus it is the safest to use sexp as type as all functions withn *ETR* are defined for sexp**. Additionally two other types are possible:
...
Beyond that the external poitner cannot only return SEXP objects. Further, possibilities are:
