...
Instead of passing the raw pointer directly it is also possible to pass it wrapped in a class BorrowPtr. As a side note it does not make a difference whether the argument is passed by reference or not. Here is an example for this:
